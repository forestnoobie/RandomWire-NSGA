# [Reference] CVdevKit/core/lr_scheduler.py
...
class LRScheduler(object):
    ...
    # args.step, args.decay_factor, args.targetlr, args.power, args.warmup_lr, args.epochs, args.warmup_epochs
...
#         assert (T >= 0 and T <= self.max_iter)    # args_train.epoch = -1 로 지정했을 때 여기서 assert 발생함.
