...
def create_toolbox_for_NSGA_RWNN(num_graph, args_train, stage_pool_path):
    ...
    toolbox.register('evaluate', evaluate,
                    args_train=args_train, stage_pool_path=stage_pool_path)
...
"""
def evaluate(individual, args_train, stage_pool_path, channels=109):  # individual
